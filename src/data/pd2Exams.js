    ...
    questions: [
      {
        id: "pt1-q1",
        sentence:
          "Hun meldte sig hurtigt til en sprogskole, hvor hun mødte andre ______ udlændinge.",
        sentenceEn:
          "She quickly signed up for a language school, where she met other young foreigners.",
        answer: "unge",
        blank: "unge",
      ...
      },
      {
        id: "pt1-q3",
        sentence:
          "Hun brugte derfor mange aftener på at ______ med dem over video.",
        sentenceEn:
          "She therefore spent many evenings calling them over video.",
        answer: "ringe",
        blank: "ringe",
      ...
      },
      {
        id: "pt1-q4",
        sentence:
          "Efter et par måneder begyndte hun at tage del i forskellige aktiviteter i ______.",
        sentenceEn:
          "After a couple of months she started taking part in various activities in the village.",
        answer: "landsbyen",
        blank: "landsbyen",
      ...
      },
      {
        ...
        sentenceEn:
          "At the language school she established good communication with her teacher.",
      ...
      },
      {
        ...
        sentenceEn:
          "Soon she dared to ask for help when something was difficult.",
        answer: "svært",
        blank: "svært",
      ...
      },
      {
        id: "pt1-q8",
        sentence:
          "Hun synes, det er meningsfuldt at ______ for andre mennesker.",
    ...
    questions: [
      {
        id: "pt2-q1",
        sentence:
          "Ahmed ﬂyttede til en mindre dansk by sidste år for at arbejde som ______ chauffør.",
        sentenceEn:
          "Ahmed moved to a smaller Danish town last year to work as a bus driver.",
        answer: "bus",
        blank: "bus",
      ...
      },
      {
        id: "pt2-q2",
        sentence:
          "I begyndelsen følte han sig ______, når han skulle tale med kunderne.",
        sentenceEn:
          "In the beginning he felt insecure when he had to talk to the customers.",
        answer: "usikker",
        blank: "usikker",
      ...
      },
      {
        id: "pt2-q3",
        sentence:
          "Fællesskabet gav ham et ______, som han havde savnet siden flytningen.",
        sentenceEn:
          "The community gave him a fellowship that he had missed since the move.",
        answer: "fællesskab",
        blank: "fællesskab",
      ...
      },
      {
        id: "pt2-q4",
        sentence:
          "For at forbedre sit sprog meldte Ahmed sig også til et aftenkursus på ______.",
        sentenceEn:
          "To improve his language Ahmed signed up for an evening course at the language school.",
        answer: "sprogskolen",
        blank: "sprogskolen",
      ...
      },
      {
        ...
        sentenceEn:
          "At first it was difficult to follow the coach's instructions.",
        answer: "svært",
        blank: "svært",
        hint: "Ikke nemt (not easy).",
      ...
      },
      {
        id: "pt2-q7",
        sentence:
          "På en af turene købte han endelig nye møbler til sin ______.",
        sentenceEn:
          "On one of the trips he finally bought new furniture for his apartment.",
        answer: "lejlighed",
        blank: "lejlighed",
      ...
      },
      {
        id: "pt2-q8",
        sentence:
          "Med tiden udviklede Ahmed et stærkt ______ i lokalsamfundet.",
        sentenceEn:
          "Over time Ahmed developed a strong network in the local community.",
        answer: "netværk",
        blank: "netværk",
      ...
      },
      {
        id: "pt2-q9",
        sentence:
          "Ahmed er glad for sin beslutning og ser frem til sin ______ i Danmark.",
        sentenceEn:
          "Ahmed is happy with his decision and looks forward to his future in Denmark.",
        answer: "fremtid",
        blank: "fremtid",
    ...
    questions: [
      {
        ...
        sentenceEn:
          "In the beginning he didn't know anyone in the city and felt lonely.",
        answer: "ensom",
        blank: "ensom",
      ...
      },
      {
        id: "pt3-q3",
        sentence:
          "Han meldte sig til en løbeklub for at holde sig i form og møde nye ______.",
        sentenceEn:
          "He joined a running club to stay in shape and meet new friends.",
        answer: "venner",
        blank: "venner",
      ...
      },
      {
        id: "pt3-q4",
        sentence:
          "Han skulle læse mange sider hver uge og skrive ______ opgaver.",
        sentenceEn:
          "He had to read many pages every week and write academic assignments.",
        answer: "akademiske",
        blank: "akademiske",
      ...
      },
      {
        id: "pt3-q5",
        sentence:
          "Han ringede derfor ofte hjem for at ______ med sine forældre og få gode råd.",
        sentenceEn:
          "Therefore he often called home to talk with his parents and get good advice.",
        answer: "tale",
        blank: "tale",
      ...
      },
      {
        id: "pt3-q6",
        sentence:
          "Hans mad ______ blev bedre, og han opdagede, hvor hyggeligt det er at lave mad sammen.",
        sentenceEn:
          "His food taste improved, and he discovered how cozy it is to cook together.",
        answer: "smag",
        blank: "smag",
      ...
      },
      {
        ...
        sentenceEn:
          "After the exam he found a student job as a waiter at a café.",
        answer: "tjener",
        blank: "tjener",
      ...
      },
      {
        id: "pt3-q8",
        sentence:
          "Han ﬁk ﬂere nye venner og følte sig efterhånden ______ i København.",
        sentenceEn:
          "He made more new friends and eventually felt at home in Copenhagen.",
        answer: "hjemme",
        blank: "hjemme",
      ...
      },
      {
        id: "pt3-q9",
        sentence:
          "Han har ______ et lille netværk af mennesker, som han kan dele glæder og udfordringer med.",
        sentenceEn:
          "He has built up a small network of people with whom he can share joys and challenges.",
        answer: "opbygget",
        blank: "opbygget",
    ...
    questions: [
      {
        id: "pt4-q1",
        sentence:
          "Han meldte sig hurtigt til en sprogskole, hvor han mødte ______ udlændinge.",
        sentenceEn:
          "He quickly signed up for a language school where he met other foreigners.",
        answer: "andre",
        blank: "andre",
      ...
      },
      {
        id: "pt4-q2",
        sentence:
          "I begyndelsen syntes han, at det danske vejr var ______ og mørkt.",
        sentenceEn:
          "In the beginning he thought the Danish weather was cold and dark.",
        answer: "kolde",
        blank: "kolde",
      ...
      },
      {
        id: "pt4-q3",
        sentence:
          "Han brugte derfor mange aftener på at ______ med dem på videoopkald.",
        sentenceEn:
          "He therefore spent many evenings calling them on video calls.",
        answer: "ringe",
        blank: "ringe",
      ...
      },
      {
        id: "pt4-q4",
        sentence:
          "Han tilmeldte sig en fodboldklub, hvor han fandt et godt ______.",
        sentenceEn:
          "He joined a football club where he found a good community.",
        answer: "fællesskab",
        blank: "fællesskab",
      ...
      },
      {
        ...
        sentenceEn:
          "At the language school he got a good relationship with his teacher.",
        answer: "relation",
        blank: "relation",
      ...
      },
      {
        ...
        sentenceEn:
          "Soon he dared to ask for help when something was difficult.",
        answer: "svært",
        blank: "svært",
      ...
      },
      {
        id: "pt4-q8",
        sentence:
          "Han synes, det er meningsfuldt at ______ for andre mennesker.",
    ...
    questions: [
      {
        id: "pt5-q1",
        sentence:
          "Han begyndte på en danskuddannelse og mødte andre ______ udlændinge.",
        sentenceEn:
          "He started a Danish education and met other newly arrived foreigners.",
        answer: "nytilﬂyttede",
        blank: "nytilﬂyttede",
      ...
      },
      {
        id: "pt5-q2",
        sentence:
          "Vejret virkede meget ______ om vinteren, og han savnede solen.",
        sentenceEn:
          "The weather seemed very cold in the winter, and he missed the sun.",
        answer: "kolde",
        blank: "kolde",
      ...
      },
      {
        id: "pt5-q4",
        sentence:
          "Snart fandt han et frivilligt arbejde i ______, hvor han hjalp børn.",
        sentenceEn:
          "Soon he found voluntary work in the sports club, where he helped children.",
      ...
      },
      {
        ...
        sentenceEn:
          "There he learned new friends and improved his Danish pronunciation.",
        answer: "venner",
        blank: "venner",
      ...
      },
      {
        id: "pt5-q6",
        sentence:
          "Hans ______ for dansk mad voksede også, især efter at have smagt smørrebrød.",
        sentenceEn:
          "His taste for Danish food also grew, especially after tasting smørrebrød.",
        answer: "smag",
        blank: "smag",
      ...
      },
      {
        id: "pt5-q7",
        sentence:
          "Han udviklede en god ______ til sin lærer, som motiverede ham til at fortsætte.",
        sentenceEn:
          "He developed a good relationship with his teacher, who motivated him to continue.",
        answer: "relation",
        blank: "relation",
      ...
      },
      {
        id: "pt5-q8",
        sentence:
          "Læreren motiverede ham til at fortsætte, selv når det var ______.",
        sentenceEn:
          "The teacher motivated him to continue, even when it was difficult.",
        answer: "svært",
        blank: "svært",
      ...
      },
      {
        id: "pt5-q9",
        sentence:
          "I dag føler han sig ______ i lokalsamfundet og har lyst til at hjælpe andre.",
        sentenceEn:
          "Today he feels active in the local community and wants to help others.",
        answer: "aktiv",
        blank: "aktiv",
    ...
    questions: [
      {
        id: "pt6-q1",
        sentence:
          "Han mødte mange ______ mennesker, der ligesom ham gerne ville lære sproget.",
        sentenceEn:
          "He met many friendly people who, like him, wanted to learn the language.",
        answer: "venlige",
        blank: "venlige",
      ...
      },
      {
        id: "pt6-q3",
        sentence:
          "Han brugte derfor mange aftener på at ______ med dem over video.",
      ...
      },
      {
        ...
        sentenceEn:
          "After a couple of months he started to get involved in the local community.",
      ...
      },
      {
        ...
        sentenceEn:
          "At the course he developed a warm friendship with his teacher.",
        answer: "venskab",
        blank: "venskab",
      ...
      },
      {
        ...
        sentenceEn:
          "He is proud of having created a strong network in Denmark.",
        answer: "netværk",
        blank: "netværk",
    ...
    questions: [
      {
        ...
        sentenceEn:
          "He was nervous because he did not know the new passengers.",
        answer: "nye",
        blank: "nye",
      ...
      },
      {
        id: "pt7-q6",
        sentence:
          "Han lærte at tage tingene ______, selv når der var mange mennesker.",
        sentenceEn:
          "He learned to take things calmly, even when there were many people.",
        answer: "roligt",
        blank: "roligt",
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: "pt8-q5",
        sentence:
          "Han fandt også en lille ______, der solgte hans yndlingsretter.",
        sentenceEn:
          "He also found a small kiosk that sold his favourite dishes.",
        answer: "kiosk",
        blank: "kiosk",
      ...
      },
      {
        id: "pt8-q6",
        sentence:
          "På studiet fik han en god ______ med sin danske studiekammerat.",
        sentenceEn:
          "At university, he developed a good relationship with his Danish classmate.",
        answer: "relation",
        blank: "relation",
      ...
      },
      {
        ...
        sentenceEn:
          "There he gained new friends and an interest in local culture.",
        answer: "interesse",
        blank: "interesse",
    ...
    questions: [
      {
        ...
        sentenceEn:
          "In the beginning, he lived with his supportive family in Aarhus.",
        answer: "støtte",
        blank: "støtte",
      ...
      },
      {
        id: "pt9-q2",
        sentence:
          "På universitetet mødte han mange ______ studerende fra hele verden.",
        sentenceEn:
          "At the university, he met many friendly students from all over the world.",
        answer: "venlige",
        blank: "venlige",
      ...
      },
      {
        id: "pt9-q3",
        sentence:
          "Det første halve år syntes han, at sproget var ______ at udtale.",
        sentenceEn:
          "The first half year he thought the language was difficult to pronounce.",
        answer: "svært",
        blank: "svært",
        hint: "Ikke nemt (difficult).",
      ...
      },
      {
        id: "pt9-q4",
        sentence:
          "For at forbedre sine færdigheder begyndte han at ______ med lokale.",
        sentenceEn:
          "To improve his skills, he started to spar (practice) with locals.",
        answer: "sparre",
        blank: "sparre",
      ...
      },
      {
        id: "pt9-q7",
        sentence:
          "Han fik et deltidsjob og begyndte at ______ for sin egen lejlighed.",
        sentenceEn:
          "He got a part-time job and began to save for his own apartment.",
        answer: "satte",
        blank: "satte",
      ...
      },
      {
        id: "pt9-q8",
        sentence:
          "Han valgte at blive i Danmark, fordi han ______ den åbne kultur.",
        sentenceEn:
          "He chose to stay in Denmark because he loves the open culture.",
        answer: "elsker",
        blank: "elsker",
      ...
      },
      {
        id: "pt9-q9",
        sentence:
          "Han meldte sig som frivillig, så han kunne ______ sine erfaringer.",
    ...
    questions: [
      {
        ...
        sentenceEn:
          "It was difficult for him to find his way around the new environment.",
        answer: "svært",
        blank: "svært",
        hint: "Ikke nemt (difficult).",
      ...
      },
      {
        id: "pt10-q3",
        sentence:
          "Han ______ hurtigt mange fælles interesser med de andre medlemmer.",
        sentenceEn:
          "He quickly shared many common interests with the other members.",
        answer: "delte",
        blank: "delte",
      ...
      },
      {
        id: "pt10-q4",
        sentence:
          "Det gav ham stor ______ at se børnene blive gladere og dygtigere.",
        sentenceEn:
          "It gave him great joy to see the children become happier and more skilled.",
        answer: "glæde",
        blank: "glæde",
      ...
      },
      {
        id: "pt10-q8",
        sentence:
          "Nu træner han to gange om ugen og har fået et endnu større ______.",
        sentenceEn:
          "Now he trains twice a week and has gained an even larger network.",
        answer: "netværk",
        blank: "netværk",
      ...
      },
      {
        id: "pt10-q9",
        sentence:
          "Han ser frem til at blive færdiguddannet og ______ i Danmark.",
...
• at rejse (travel), at flyve (fly), at køre (drive)`,
  ...
  // ============ 2019 VINTER ============
  {
    id: "pd2-2019-vinter-ls1-o1",
    year: 2019,
    season: "Vinter",
    seasonEn: "Winter",
    type: "Læseforståelse 1 - Opgave 1",
    typeEn: "Reading Comprehension 1 - Info Search",
    level: "PD2",
    lesson: {
      title: "Information fra tekster",
      titleEn: "Information from texts",
      topics: ["info-search", "vocabulary"],
      content: `Find specific information in the texts about ice cream shops, folk high schools, and hotels.`,
    },
    questions: [
      {
        id: "q1",
        sentence: "På hvilken isbar kan man købe en is, som er sukkerfri?",
        answer: "Vildglad",
        hint: "Søg under Isbarer i København.",
        options: ["Vildglad", "Nicecream", "Paradis Is", "Olufs Is"],
      },
      {
        id: "q2",
        sentence: "På hvilken højskole kan man komme på cykelkursus?",
        answer: "Silkeborg Højskole",
        hint: "Søg under Højskoler med korte kurser.",
        options: [
          "Silkeborg Højskole",
          "Egmont Højskolen",
      ...
      },
      {
        id: "q3",
        sentence:
          "På hvilken skole er alle værelserne egnede for handicappede?",
        answer: "Egmont Højskolen",
        hint: "Søg under Højskoler med korte kurser.",
        options: [
          "Egmont Højskolen",
          "Ry Højskole",
      ...
      {
        id: "q4",
        sentence: "På hvilken højskole kan man lære om nordisk kultur?",
        answer: "Rødding Højskole",
        hint: "Søg under Højskoler med korte kurser.",
        options: [
          "Rødding Højskole",
          "Testrup Højskole",
      ...
      {
        id: "q5",
        sentence: "På hvilket hotel er der nyrenoverede værelser?",
        answer: "Hotel Ebeltoft Strand",
        hint: "Søg under Hoteller på Djursland.",
        options: [
      ...
      {
        id: "q6",
        sentence: "På hvilket hotel er der cykeludlejning?",
        answer: "Hotel Marina",
        hint: "Søg under Hoteller på Djursland.",
        options: [
          "Hotel Marina",
  ...
  {
    id: "pd2-2019-vinter-ls1-o2",
    year: 2019,
    season: "Vinter",
    seasonEn: "Winter",
    type: "Læseforståelse 1 - Opgave 2",
    typeEn: "Reading Comprehension 1 - Advertisements",
    level: "PD2",
    lesson: {
      title: "Annoncer",
      titleEn: "Advertisements",
      topics: ["vocabulary", "context"],
      content: `Match the missing phrases to the correct advertisements.`,
    },
    questions: [
      {
        id: "q7",
        sentence: "Vi har døgnvagt ved akut sygdom.",
        answer: "B",
        hint: "Ad B: Dyrlægerne i Centrum.",
        options: ["B", "A", "D", "C"],
      },
      {
        id: "q8",
        sentence: "Varighed: 8 uger.",
        answer: "E",
        hint: "Ad E: Hundeskolen i Gundersborg.",
        options: ["E", "B", "A", "I"],
      },
      {
        id: "q9",
        sentence: "Træner søges.",
        answer: "C",
        hint: "Ad C: HUF Boldklub.",
        options: ["C", "A", "D", "H"],
      },
      {
        id: "q10",
        sentence: "Skal du købe ny madras?",
        answer: "F",
        hint: "Ad F: Neoz.",
        options: ["F", "I", "G", "A"],
      },
      {
        id: "q11",
        sentence: "Åbningstilbud.",
        answer: "I",
        hint: "Ad I: Nyby Sport.",
        options: ["I", "H", "G", "F"],
      },
      {
        id: "q12",
        sentence: "14 dages gratis træning på alle vores hold.",
        answer: "G",
        hint: "Ad G: Fitnesshuset.",
        options: ["G", "F", "I", "H"],
      },
    ],
  },
  {
    ...
    questions: [
      {
        sentence:
          "Magnus har planlagt at tage bilen, ______ da han sætter sig ind i den, vil den ikke starte.",
        answer: "men",
        hint: "Conjunction: 'men' (but).",
        options: ["men", "og", "selvom", "for"],
      },
      {
        sentence:
          "Men da han skal betale, opdager han et nyt problem: han har hverken ______ at få sin pung eller sin telefon med.",
        answer: "husket",
        hint: "Past participle: 'husket' (remembered).",
        options: ["husket", "glemt", "med", "for"],
      },
      {
        sentence: "Magnus vil ikke tage toget ______ billet.",
        answer: "uden",
        hint: "Preposition: 'uden' (without).",
        options: ["uden", "med", "for", "ikke"],
      },
      {
        sentence:
          "Selvom de ______ kender hinanden, tilbyder hun at købe en billet.",
        answer: "ikke",
        hint: "Negation: 'ikke' (not).",
        options: ["ikke", "alle", "godt", "kun"],
      },
      {
        sentence:
          "Han er lettet, men også lidt nervøs, ______ han tænker på samtalen.",
        answer: "for",
        hint: "Conjunction: 'for' (because).",
        options: ["for", "men", "selvom", "og"],
      },
      {
        sentence: "Samtalen går heldigvis godt, så Magnus er ret ______.",
        answer: "tilfreds",
        hint: "Adjective: 'tilfreds' (satisfied).",
        options: ["tilfreds", "skuffet", "godt", "glemt"],
      },
      {
        sentence: "Han sender hende ikke ______ pengene, men også en sms.",
        answer: "kun",
        hint: "Adverb: 'kun' (only) used in 'ikke kun... men også'.",
        options: ["kun", "alle", "godt", "og"],
      },
      {
        sentence: "Denne gang har Magnus ikke ______ sin pung.",
        answer: "glemt",
        hint: "Past participle: 'glemt' (forgotten).",
        options: ["glemt", "husket", "med", "for"],
      },
    ],
  },
  {
    id: "pd2-2019-vinter-ls2-o4",
    year: 2019,
    season: "Vinter",
    type: "Læseforståelse 2 - Opgave 4",
    level: "PD2",
    lesson: {
      title: "Sofie er alenemor",
      titleEn: "Sofie is a single mother",
    },
    questions: [
      {
        sentence: "Hun er rigtig glad for det. ______.",
        answer: "Men hun har en travl hverdag",
        hint: "Matching sentence (A): But she has a busy everyday life.",
        options: [
          "Men hun har en travl hverdag",
          "Det er lidt hårdt for Sofie",
          "Men det gør Hugo ikke",
          "Det gør Hugo også",
        ],
      },
      {
        sentence:
          "Han kommer kun til København en eller to dage om måneden... ______.",
        answer: "Det er lidt hårdt for Sofie",
        hint: "Matching sentence (D): It is a bit hard for Sofie.",
        options: [
          "Det er lidt hårdt for Sofie",
          "Men det gør Hugo ikke",
          "Det gør Hugo også",
          "Hun har bare ikke råd endnu",
        ],
      },
      {
        sentence:
          "Derfor skal Hugo nogle gange passes om aftenen og om natten. ______.",
        answer: "Men det ikke noget problem",
        hint: "Matching sentence (H): But it is not a problem.",
        options: [
          "Men det ikke noget problem",
          "Men det gør Hugo ikke",
          "Det gør Hugo også",
          "Hun har bare ikke råd endnu",
        ],
      ...
      {
        sentence:
          "Nogle af de andre børn græder altid... ______. I starten var han somme tider lidt ked af det.",
        answer: "Men det gør Hugo ikke",
        hint: "Matching sentence (B): But Hugo doesn't.",
        options: [
          "Men det gør Hugo ikke",
          "Det gør Hugo også",
          "Så savner Hugo faktisk sin børnehave",
          "Men hun har en travl hverdag",
        ],
      },
      {
        sentence:
          "I stedet er han derhjemme sammen med hende, og det nyder Sofie. ______.",
        answer: "Det gør Hugo også",
        hint: "Matching sentence (E): Hugo does too.",
        options: [
          "Det gør Hugo også",
          "Så savner Hugo faktisk sin børnehave",
          "Hun har bare ikke råd endnu",
      ...
      {
        sentence: "Sofie håber, at hun har sparet penge nok sammen... ______.",
        answer: "Hun har bare ikke råd endnu",
        hint: "Matching sentence (F): She just can't afford it yet.",
        options: [
          "Hun har bare ikke råd endnu",
          "Det er lidt hårdt for Sofie",
          "Hun har faktisk already købt den",
          "Det gør Hugo også",
        ],
      },
    ],
  ...
  {
    id: "pd2-2019-vinter-ls2-o5",
    year: 2019,
    season: "Vinter",
    type: "Læseforståelse 2 - Opgave 5",
    level: "PD2",
    lesson: {
      title: "Interview med Yonas",
      titleEn: "Interview with Yonas",
    },
    questions: [
      {
        sentence: "Hvor længe har du været vikar?",
        answer:
          "Jeg startede lige efter min 40 års fødselsdag, så det må snart være i tre år.",
        hint: "Matching paragraph (A): I started right after my 40th birthday...",
        options: [
          "Jeg startede lige efter min 40 års fødselsdag...",
          "Ja, for det meste. Det er lidt usikkert...",
          "Det er lidt forskelligt. Det kan skifte fra uge til uge.",
          "Først og fremmest har jeg jo brug for at tjene penge.",
        ],
      },
      {
        sentence: "Hvad skal en vikar være god til?",
        answer:
          "Lidt af hvert. Men det vigtigste er nok, at man er fleksibel og mødestabil...",
        hint: "Matching paragraph (E): A bit of everything. But the most important...",
        options: [
          "Lidt af hvert. Men det vigtigste er nok, at man er fleksibel og mødestabil...",
          "Ja, de skifter ikke så meget. Jeg har kørekort til truck...",
          "Først og fremmest har jeg jo brug for at tjene penge.",
          "Nej, egentlig ikke. Somme tider kører jeg forbi vikarbureauet.",
        ],
      },
      {
        sentence: "Hvorfor arbejder du som vikar?",
        answer:
          "Først og fremmest har jeg jo brug for at tjene penge. Men jeg kan also well lide den frihed, jeg har i det her job.",
        hint: "Matching paragraph (G): First and foremost I need to earn money. But I also like the freedom...",
        options: [
          "Først og fremmest har jeg jo brug for at tjene penge...",
          "Lidt af hvert. Men det vigtigste er nok, at man er fleksibel...",
          "Ja, de skifter ikke så meget. Jeg har kørekort til truck...",
          "Det er lidt forskelligt. Det kan skifte fra uge til uge.",
        ],
      },
      {
        sentence: "Har du altid de samme arbejdsopgaver?",
        answer:
          "Ja, de skifter ikke så meget. Jeg har kørekort til truck, så jeg bliver tit bedt om at arbejde steder, hvor de har brug for én...",
        hint: "Matching paragraph (H): Yes, they don't change that much...",
        options: [
          "Ja, de skifter ikke så meget. Jeg har kørekort til truck...",
          "Lidt af hvert. Men det vigtigste er nok, at man er fleksibel...",
          "Nej, egentlig ikke. Somme tider kører jeg forbi vikarbureauet.",
      ...
      {
        sentence: "Tjener du nok som vikar?",
        answer:
          "Ja, for det meste. Det er lidt usikkert, fordi jeg ikke har fast arbejde...",
        hint: "Matching paragraph (B): Yes, for the most part. It's a bit uncertain...",
        options: [
          "Ja, for det meste. Det er lidt usikkert...",
          "Først og fremmest har jeg jo brug for at tjene penge.",
          "Nej, egentlig ikke. Somme tider kører jeg forbi vikarbureauet.",
          "Nej, ikke specielt. Men da jeg startede som vikar, var det værre.",
        ],
      },
      {
        sentence: "Bruger du meget tid på transport?",
        answer:
          "Nej, ikke specielt. Men da jeg startede som vikar, var det værre. Dengang havde jeg ikke bil...",
        hint: "Matching paragraph (D): No, not especially. But when I started, it was worse...",
        options: [
          "Nej, ikke specielt. Men da jeg startede som vikar, var det værre.",
          "Det er lidt forskelligt. Det kan skifte fra uge til uge.",
          "Lidt af hvert. Men det vigtigste er nok, at man er fleksibel...",
...
• billig (cheap), dyr (expensive), tilbud (offer/sale)`,
  ...
  }, // ============ 2018 VINTER ============
  {
    ...
    lesson: {
      ...
      titleEn: "Information from texts",
      topics: ["info-search", "vocabulary"],
      content: `Find specific information in the texts about nature playgrounds, Christmas markets, and apartments.`,
    },
    questions: [
      {
        id: "q1",
        sentence: "På hvilken legeplads er der en skøjtebane om vinteren?",
        answer: "Dronningemaen Naturlegeplads",
        hint: "Søg under Naturlegepladser på Fyn.",
        options: [
          "Dronningemaen Naturlegeplads",
          "Sansehaven i Nyborg",
          "Bolbro Anlæg",
          "Børnebyen",
        ],
      ...
      {
        id: "q2",
        sentence: "På hvilket julemarked kan man høre en musikskole spille?",
        answer: "Julemarked i Egtved Forsamlingshus",
        hint: "Søg under Julemarkeder i Vejle.",
        options: [
          "Julemarked i Egtved Forsamlingshus",
          "Haughus Gods Julemarked",
          "Julemarked i Metodistkirken",
          "Upcomers Designmarked",
        ],
      },
      {
        id: "q3",
        sentence:
          "På hvilket julemarked kan børnene få en nissehue af julemanden?",
        answer: "Haughus Gods Julemarked",
        hint: "Søg under Julemarkeder i Vejle.",
        options: [
          "Haughus Gods Julemarked",
          "Julemarked på torvet i Børkop",
          "Julestue i Nørremarkskirken",
          "Julemarked på Søndertorv",
        ],
      },
      {
        id: "q4",
        sentence: "På hvilket julemarked kan man købe brændte mandler?",
        answer: "Julemarked på torvet i Børkop",
        hint: "Søg under Julemarkeder i Vejle.",
        options: [
          "Julemarked på torvet i Børkop",
          "Julemarked på Bøgedal Bryghus",
          "Julemarked på Tirsbæk Slot",
          "Julemarked på Egtved Museum",
        ],
      },
      {
        id: "q5",
        sentence:
          "Hvilket nummer har den lejlighed, som bliver ledig d. 1. februar?",
        answer: "Lejlighed nr. 4",
        hint: "Søg under Lejligheder til leje i Hobro.",
        options: [
          "Lejlighed nr. 4",
          "Lejlighed nr. 3",
          "Lejlighed nr. 5",
      ...
      },
      {
        id: "q6",
        sentence:
          "Hvilket nummer har den lejlighed, som har et helt nyt køkken?",
        answer: "Lejlighed nr. 3",
        hint: "Søg under Lejligheder til leje i Hobro.",
        options: [
          "Lejlighed nr. 3",
          "Lejlighed nr. 1",
  ...
  },
  {
    ...
    questions: [
      {
        id: "q7",
        sentence: "Lækker økologisk morgenbuffet.",
        answer: "G",
        hint: "Ad G: Hotel Solblik i Refstrup.",
        options: ["G", "F", "H", "I"],
      },
      {
        id: "q8",
        sentence: "Bolig søges.",
        answer: "I",
        hint: "Ad I: Kontakt Magnus.",
        options: ["I", "F", "D", "E"],
      },
      {
        id: "q9",
        sentence: "15 % rabat og gratis fragt på alt løbetøj.",
        answer: "H",
        hint: "Ad H: SPORTSMAND.DK.",
        options: ["H", "B", "A", "C"],
      },
      {
        id: "q10",
        sentence: "Adgang til vaskekælder.",
        answer: "F",
        hint: "Ad F: Lejlighed udlejes.",
        options: ["F", "E", "C", "I"],
      },
      {
        id: "q11",
        sentence: "Dygtige trænere.",
        answer: "B",
        hint: "Ad B: Løbeklubben GAZELLEN.",
        options: ["B", "H", "A", "G"],
      },
      {
        id: "q12",
        sentence: "Flot butikslokale udlejes.",
        answer: "E",
        hint: "Ad E: Helsingør centrum.",
        options: ["E", "F", "C", "A"],
      },
    ],
  },
  {
    id: "pd2-2018-vinter-ls2-o3",
    year: 2018,
    season: "Vinter",
    type: "Læseforståelse 2 - Opgave 3",
    level: "PD2",
    lesson: {
      title: "Simon skal dyrke motion",
      titleEn: "Simon needs to exercise",
    },
    questions: [
      {
        sentence: "Simon Nielsen er ______ meget træt og mangler energi.",
        answer: "tit",
        hint: "Adverb: 'tit' (often).",
        options: ["tit", "hyggeligt", "mindre", "nemlig"],
      },
      {
        sentence: "Simon synes, det er ______ at komme i gang med motionen.",
        answer: "svært",
        hint: "Adjective: 'svært' (difficult).",
        options: ["svært", "nemlig", "normalt", "mere"],
      },
      {
        sentence:
          "Simon går ______ lange ture selv, for han synes, det er så kedeligt.",
        answer: "aldrig",
        hint: "Adverb: 'aldrig' (never).",
        options: ["aldrig", "tit", "mindre", "så"],
      },
      {
        sentence:
          "Men han synes, det lyder rigtig ______ at gå sammen med andre.",
        answer: "hyggeligt",
        hint: "Adjective: 'hyggeligt' (cozy/pleasant).",
        options: ["hyggeligt", "svært", "mere", "normalt"],
      },
      {
        sentence:
          "Simon fortæller, at hans læge har sagt, at han skal ______ sig noget mere.",
        answer: "bevæge",
        hint: "Verb: 'bevæge' (move).",
        options: ["bevæge", "stoppe", "fortsætte", "lægge"],
      },
      {
        sentence:
          "Jesper siger, at han faktisk også gerne vil dyrke mere motion, ______ de to mænd aftaler...",
        answer: "så",
        hint: "Conjunction: 'så' (so).",
        options: ["så", "men", "nemlig", "mere"],
      },
      {
        sentence:
          "Han er også stadig træt hver dag, og han har lyst til at ______ med turene.",
        answer: "stoppe",
        hint: "Verb: 'stoppe' (stop).",
        options: ["stoppe", "fortsætte", "bevæge", "lægge"],
      },
      {
        sentence:
          "Så han vælger at ______, og efter et par uger kan han mærke, at motionen virker.",
        answer: "fortsætte",
        hint: "Verb: 'fortsætte' (continue).",
        options: ["fortsætte", "stoppe", "bevæge", "lægge"],
      },
      {
        sentence: "Han føler sig ______ træt end før.",
        answer: "mindre",
        hint: "Comparative: 'mindre' (less).",
        options: ["mindre", "mere", "normalt", "tit"],
      },
    ],
  },
  {
    id: "pd2-2018-vinter-ls2-o4",
    year: 2018,
    season: "Vinter",
    type: "Læseforståelse 2 - Opgave 4",
    level: "PD2",
    lesson: {
      title: "Kamma bor i bofællesskab",
      titleEn: "Kamma lives in a community",
    },
    questions: [
      {
        sentence: "Kamma var meget ked af det, og hun følte sig ensom. ______.",
        answer: "Det gør hun ikke mere",
        hint: "Matching sentence (A): She doesn't anymore.",
        options: [
          "Det gør hun ikke mere",
          "Men det interesserer ikke Kamma",
          "Men den passer fint til hende",
          "Det skal Kamma snart prøve",
        ],
      },
      {
        sentence:
          "Kamma har en af de mindste med to værelser, køkken og bad og en lille altan. ______.",
        answer: "Men den passer fint til hende",
        hint: "Matching sentence (G): But it suits her fine.",
        options: [
          "Men den passer fint til hende",
          "Den er lidt for lille til hende",
          "Men det interesserer ikke Kamma",
          "Det gør Kamma tit",
        ],
      },
      {
        sentence:
          "Der kan beboerne bl.a. gå til forskellige slags motion, fx yoga, gymnastik og dans. ______.",
        answer: "Men det interesserer ikke Kamma",
        hint: "Matching sentence (E): But that doesn't interest Kamma.",
        options: [
          "Men det interesserer ikke Kamma",
          "Det gør Kamma tit",
          "Det skal Kamma snart prøve",
      ...
      {
        sentence:
          "Man skal bare tilmelde sig dagen før, hvis man gerne vil spise med. ______.",
        answer: "Det gør Kamma tit",
        hint: "Matching sentence (B): Kamma does that often.",
        options: [
          "Det gør Kamma tit",
          "Det skal Kamma snart prøve",
          "Men det interesserer ikke Kamma",
          "Hun har også fået en god veninde",
        ],
      },
      {
        sentence:
          "Som beboer i bofællesskabet kan man låne fælleshuset helt gratis... ______.",
        answer: "Det skal Kamma snart prøve",
        hint: "Matching sentence (H): Kamma will try that soon.",
        options: [
          "Det skal Kamma snart prøve",
          "Det gør Kamma tit",
          "Hun har også fået en god veninde",
      ...
      {
        sentence:
          "Hun føler sig aldrig ensom. ______. Derfor er det perfekt, at hun har sin egen lejlighed.",
        answer: "Men somme tider vil hun gerne være alene",
        hint: "Matching sentence (C): But sometimes she wants to be alone.",
        options: [
          "Men somme tider vil hun gerne være alene",
          "Hun har også fået en god veninde",
          "Den er lidt for lille til hende",
          "Det gør Kamma tit",
        ],
  ...
  {
    id: "pd2-2018-vinter-ls2-o5",
    year: 2018,
    season: "Vinter",
    type: "Læseforståelse 2 - Opgave 5",
    level: "PD2",
    lesson: {
      title: "Interview med Lasse",
      titleEn: "Interview with Lasse",
    },
    questions: [
      {
        sentence: "Har der været andre fodboldspillere i din familie før dig?",
        answer:
          "Nej, faktisk ikke. I hvert fald ikke på et professionelt niveau. Min far elsker fodbold...",
        hint: "Matching paragraph (E): No, not actually...",
        options: [
          "Nej, faktisk ikke. I hvert fald ikke på et professionelt niveau. Min far elsker fodbold...",
          "Ja, det tror jeg, de fleste professionelle fodboldspillere har. Det startede i hvert fald tidligt for mig.",
          "Helt fint. Vi har kendt hinanden i mange år, og fodbold har altid været en stor del af mit liv.",
          "Det er svært at sige helt præcist. Men vi træner en del.",
        ],
      },
      {
        sentence: "Har du altid været interesseret i fodbold?",
        answer:
          "Ja, det tror jeg, de fleste professionelle fodboldspillere har. Det startede i hvert fald tidligt for mig.",
        hint: "Matching paragraph (G): Yes, I think most professional players have...",
        options: [
          "Ja, det tror jeg, de fleste professionelle fodboldspillere har. Det startede i hvert fald tidligt for mig.",
          "Ja, meget interesseret! Han elsker at se, når jeg spiller kamp...",
          "Helt fint. Vi have kendt hinanden i mange år...",
          "Nej, ikke rigtigt. Lige nu prioriterer jeg fodbold.",
        ],
      },
      {
        sentence: "Hvor meget tid bruger du på fodbold?",
        answer:
          "Det er svært at sige helt præcist. Men vi træner en del. For det meste er jeg faktisk til træning cirka fem gange om ugen.",
        hint: "Matching paragraph (D): It's hard to say exactly. But we train a lot...",
        options: [
          "Det er svært at sige helt præcist. Men vi træner en del. For det meste er jeg faktisk til træning cirka fem gange om ugen.",
          "Helt fint. Vi har kendt hinanden i mange år...",
          "Jeg synes, de alle sammen er nogle dygtige spillere...",
          "Nej, ikke rigtigt. Lige nu prioriterer jeg fodbold.",
        ],
      },
      {
        sentence: "Hvordan har du det med dine holdkammerater?",
        answer:
          "Jeg synes, de alle sammen er nogle dygtige spillere og nogle flinke mennesker. Vi fungerer rigtig godt sammen...",
        hint: "Matching paragraph (C): I think they are all skilled players and nice people...",
        options: [
          "Jeg synes, de alle sammen er nogle dygtige spillere og nogle flinke mennesker. Vi fungerer rigtig godt sammen...",
          "Helt fint. Vi har kendt hinanden i mange år...",
          "Det er et godt spørgsmål. Der kan jo ske så meget.",
          "Ja, meget interesseret! Han elsker at se, når jeg spiller kamp...",
        ],
      },
      {
        sentence: "Har du tid til andet end fodbold og familie?",
        answer:
          "Nej, ikke rigtigt. Lige nu prioriterer jeg fodbold. Når jeg ikke træner eller spiller kamp, er jeg sammen med min kone og vores søn.",
        hint: "Matching paragraph (H): No, not really. Right now I prioritize football...",
        options: [
          "Nej, ikke rigtigt. Lige nu prioriterer jeg fodbold. Når jeg ikke træner eller spiller kamp, er jeg sammen med min kone og vores søn.",
          "Helt fint. Vi har kendt hinanden i mange år...",
          "Det er et godt spørgsmål. Der kan jo ske så meget.",
          "Ja, det tror jeg, de fleste professionelle fodboldspillere har.",
        ],
      },
      {
        sentence: "Hvad med fremtiden?",
        answer:
          "Det er et godt spørgsmål. Der kan jo ske så meget. Men jeg vil gerne fortsætte med at spille meget fodbold nogle år endnu.",
        hint: "Matching paragraph (B): That's a good question. So much can happen...",
        options: [
          "Det er et godt spørgsmål. Der kan jo ske så meget. Men jeg vil gerne fortsætte med at spille meget fodbold nogle år endnu.",
          "Helt fint. Vi har kendt hinanden i mange år...",
          "Jeg synes, de alle sammen er nogle dygtige spillere...",
          "Nej, faktisk ikke. I hvert fald ikke på et professionelt niveau.",
        ],
      },
    ],
  }, // ============ SKRIFTLIG EXAMS ============
...
• varmt (warm), koldt (cold), overskyet (overcast)`,
    ...
    questions: [
      {
        id: "q1",
        sentence: "I dag ______ solen, og det er 20 grader.",
        sentenceEn: "Today the sun shines and it is 20 degrees.",
        answer: "skinner",
        blank: "skinner",
        hint: "at skinne (to shine) — present tense",
        ruleId: "present-tense-r",
        verb: "at skinne",
        tense: "present",
      },
      {
        id: "q2",
        sentence: "I går ______ det hele dagen.",
        sentenceEn: "Yesterday it rained all day.",
        answer: "regnede",
        blank: "regnede",
        hint: "at regne (to rain) — past tense, Group 1",
        ruleId: "past-tense-group1",
        verb: "at regne",
        tense: "past",
      },
      {
        id: "q3",
        sentence: "Om vinteren ______ det tit i Danmark.",
        sentenceEn: "In winter it snows often in Denmark.",
        answer: "sner",
        blank: "sner",
        hint: "at sne (to snow) — present tense",
        ruleId: "present-tense-r",
        verb: "at sne",
        tense: "present",
      },
      {
        id: "q4",
        sentence: "Det ______ meget i storm i forgårs.",
        sentenceEn: "It blew a lot during the storm the day before yesterday.",
        answer: "blæste",
        blank: "blæste",
        hint: "at blæse (to blow) — past tense",
        ruleId: "past-tense-group1",
        verb: "at blæse",
        tense: "past",
      },
      {
        id: "q5",
        sentence: "Temperaturen ______ 15 grader i dag.",
        sentenceEn: "The temperature is 15 degrees today.",
        answer: "er",
        blank: "er",
        hint: "at være (to be) — present",
        ruleId: "present-tense-r",
        verb: "at være",
        tense: "present",
      },
      {
        id: "q6",
        sentence: "Vi ______ paraply med, fordi det regner.",
        sentenceEn: "We bring an umbrella because it rains.",
        answer: "tager",
        blank: "tager",
        hint: "at tage (to take) — present tense",
        ruleId: "present-tense-r",
        verb: "at tage",
        tense: "present",
      },
      {
        id: "q7",
        sentence: "Foråret ______ i marts.",
        sentenceEn: "Spring begins in March.",
        answer: "begynder",
        blank: "begynder",
        hint: "at begynde (to begin) — present tense",
        ruleId: "present-tense-r",
        verb: "at begynde",
        tense: "present",
      },
      {
        id: "q8",
        sentence: "Det ______ tåget i morges.",
        sentenceEn: "It was foggy this morning.",
        answer: "var",
        blank: "var",
        hint: "at være (to be) — past tense",
        ruleId: "past-tense-group3",
        verb: "at være",
        tense: "past",
      },
...
• størrelse (size), passe (fit), prøverum (fitting room)`,
    ...
    questions: [
      {
        id: "q1",
        sentence: "I dag ______ jeg en blå trøje på.",
        sentenceEn: "Today I am wearing a blue sweater.",
        answer: "har",
        blank: "har",
        hint: 'at have (to have) — "har ... på" = wearing',
        ruleId: "present-tense-r",
        verb: "at have",
        tense: "present",
      },
      {
        id: "q2",
        sentence: "Kan jeg ______ denne kjole?",
        sentenceEn: "Can I try on this dress?",
        answer: "prøve",
        blank: "prøve",
        hint: "Modal verb + infinitive (at prøve)",
        ruleId: "modal-infinitive",
        verb: "at prøve",
        tense: "infinitive",
      },
      {
        id: "q3",
        sentence: "Jakken ______ 599 kroner.",
        sentenceEn: "The jacket costs 599 kroner.",
        answer: "koster",
        blank: "koster",
        hint: "at koste (to cost) — present tense",
        ruleId: "present-tense-r",
      ...
      {
        id: "q4",
        sentence: "Bukserne ______ ikke. De er for store.",
        sentenceEn: "The trousers don't fit. They are too big.",
        answer: "passer",
        blank: "passer",
        hint: "at passe (to fit) — present tense",
        ruleId: "present-tense-r",
        verb: "at passe",
        tense: "present",
      },
      {
        id: "q5",
        sentence: "Du skal ______ varmt tøj på om vinteren.",
        sentenceEn: "You must wear warm clothes in winter.",
        answer: "have",
        blank: "have",
        hint: "Modal verb + infinitive (at have)",
        ruleId: "modal-infinitive",
        verb: "at have",
        tense: "infinitive",
      },
      {
        id: "q6",
        sentence: "Skoene ______ mine yndlingssko.",
        sentenceEn: "The shoes are my favorite shoes.",
        answer: "er",
        blank: "er",
        hint: "at være (to be) — present",
        ruleId: "present-tense-r",
...
• Øresundsbroen (the bridge), grænse (border), indbygger (inhabitant)`,
    ...
    questions: [
      {
        id: "q1",
        sentence: "København ______ Danmarks hovedstad.",
        sentenceEn: "Copenhagen is Denmark's capital.",
        answer: "er",
        blank: "er",
        hint: "at være (to be) — present",
        ruleId: "present-tense-r",
      ...
      {
        id: "q2",
        sentence: "I Danmark ______ man dansk.",
        sentenceEn: "In Denmark one speaks Danish.",
        answer: "taler",
        blank: "taler",
        hint: "V2: prepositional phrase first → verb second",
        ruleId: "word-order-v2",
        verb: "at tale",
        tense: "present",
      },
      {
        id: "q3",
        sentence: "Øresundsbroen ______ København og Malmø.",
        sentenceEn: "The Øresund Bridge connects Copenhagen and Malmö.",
        answer: "forbinder",
        blank: "forbinder",
        hint: "at forbinde (to connect) — present",
        ruleId: "present-tense-r",
        verb: "at forbinde",
        tense: "present",
      },
      {
        id: "q4",
        sentence: "Danmark ______ cirka 5,8 millioner indbyggere.",
        sentenceEn: "Denmark has about 5.8 million inhabitants.",
        answer: "har",
        blank: "har",
        hint: "at have (to have) — present",
        ruleId: "present-tense-r",
        verb: "at have",
        tense: "present",
      },
      {
        id: "q5",
        sentence: "Mange turister ______ Tivoli i København.",
        sentenceEn: "Many tourists visit Tivoli in Copenhagen.",
        answer: "besøger",
        blank: "besøger",
        hint: "at besøge (to visit) — present",
        ruleId: "present-tense-r",
        verb: "at besøge",
        tense: "present",
      },
      {
        id: "q6",
        sentence: "H.C. Andersen ______ født i Odense.",
        sentenceEn: "H.C. Andersen was born in Odense.",
        answer: "blev",
        blank: "blev",
        hint: "at blive (to become) — past tense, passive",
        ruleId: "past-tense-group3",
        verb: "at blive",
        tense: "past",
      },
      {
        id: "q7",
        sentence: "Landet ______ af halvøen Jylland og mange øer.",
        sentenceEn:
          "The country consists of the peninsula Jutland and many islands.",
        answer: "består",
        blank: "består",
        hint: "at bestå (to consist) — present",
        ruleId: "present-tense-r",
        verb: "at bestå",
        tense: "present",
      },
...
• CPR-nummer, NemID, borgerservice`,
    ...
    questions: [
      {
        id: "q1",
        sentence: "Alle i Danmark ______ skat.",
        sentenceEn: "Everyone in Denmark pays taxes.",
        answer: "betaler",
        blank: "betaler",
        hint: "at betale (to pay) — present",
        ruleId: "present-tense-r",
        verb: "at betale",
        tense: "present",
      },
      {
        id: "q2",
        sentence: "Man skal ______ sig hos kommunen, når man flytter.",
        sentenceEn: "One must register at the municipality when one moves.",
        answer: "melde",
        blank: "melde",
        hint: "Modal + infinitive (at melde)",
        ruleId: "modal-infinitive",
        verb: "at melde",
        tense: "infinitive",
      },
      {
        id: "q3",
        sentence:
          "Danmark har ______ et af verdens bedste uddannelsessystemer.",
        sentenceEn:
          "Denmark has gotten one of the world's best education systems.",
        answer: "fået",
        blank: "fået",
        hint: "at få (to get) — perfect, irregular",
        ruleId: "perfect-tense",
        verb: "at få",
        tense: "perfect",
      },
      {
        id: "q4",
        sentence: "Danskerne ______ meget lid på staten.",
        sentenceEn: "The Danes trust the state a lot.",
        answer: "har",
        blank: "har",
        hint: "at have (to have) — present",
        ruleId: "present-tense-r",
      ...
      {
        id: "q5",
        sentence: "Alle børn kan ______ gratis i folkeskolen.",
        sentenceEn: "All children can study for free in public school.",
        answer: "gå",
        blank: "gå",
        hint: "Modal + infinitive (at gå)",
        ruleId: "modal-infinitive",
        verb: "at gå",
        tense: "infinitive",
      },
      {
        id: "q6",
        sentence: "Sundhedsvæsenet ______ betalt af skatten.",
        sentenceEn: "The health system is paid by taxes.",
        answer: "er",
        blank: "er",
        hint: "at være — passive voice (er + participle)",
        ruleId: "present-tense-r",
        verb: "at være",
        tense: "present",
      },
...
• ondt (pain), feber (fever), medicin (medicine)`,
    ...
    questions: [
      {
        id: "q1",
        sentence: "Jeg har ondt i ______.",
        sentenceEn: "I have a headache.",
        answer: "hovedet",
        blank: "hovedet",
        hint: "hovedet = the head (definite form)",
        ruleId: "present-tense-r",
        verb: "substantiv",
        tense: "definite",
      },
      {
        id: "q2",
        sentence: "Du bør ______ til lægen.",
        sentenceEn: "You should go to the doctor.",
        answer: "gå",
        blank: "gå",
        hint: "Modal + infinitive (at gå)",
        ruleId: "modal-infinitive",
      ...
      {
        id: "q3",
        sentence: "Hun ______ feber og ondt i halsen.",
        sentenceEn: "She has a fever and sore throat.",
        answer: "har",
        blank: "har",
        hint: "at have (to have) — present",
        ruleId: "present-tense-r",
      ...
      {
        id: "q5",
        sentence: "Lægen ______ at jeg skal tage det roligt.",
        sentenceEn: "The doctor says I should take it easy.",
        answer: "siger",
        blank: "siger",
        hint: "at sige (to say) — present, irregular",
        ruleId: "present-tense-r",
        verb: "at sige",
        tense: "present",
      },
      {
        id: "q6",
        sentence: "Mine ben ______ efter løbeturen.",
        sentenceEn: "My legs hurt after the run.",
        answer: "gør ondt",
        blank: "gør ondt",
        hint: "at gøre ondt (to hurt) — present",
        ruleId: "present-tense-r",
        verb: "at gøre",
        tense: "present",
      },
...
• Possessive agreement with gender (en-words vs et-words)`,
    ...
    questions: [
      {
        id: "q1",
        sentence: "______ hedder Lars, og jeg er fra Danmark.",
        sentenceEn: "My name is Lars, and I am from Denmark.",
        answer: "Jeg",
        blank: "Jeg",
        hint: "Subject pronoun: I = jeg",
        ruleId: "present-tense-r",
        verb: "pronomen",
        tense: "subject",
      },
      {
        id: "q2",
        sentence: "Kan du hjælpe ______ med denne opgave?",
        sentenceEn: "Can you help me with this task?",
        answer: "mig",
        blank: "mig",
        hint: "Object pronoun: me = mig",
        ruleId: "modal-infinitive",
        verb: "pronomen",
        tense: "object",
      },
      {
        id: "q3",
        sentence: "______ bil er rød. (min/mit)",
        sentenceEn: "My car is red.",
        answer: "Min",
        blank: "Min",
        hint: "en bil → min bil (common gender)",
        ruleId: "present-tense-r",
        verb: "possessiv",
        tense: "common",
      },
      {
        id: "q4",
        sentence: "______ hus er stort. (min/mit)",
        sentenceEn: "My house is big.",
        answer: "Mit",
        blank: "Mit",
        hint: "et hus → mit hus (neuter gender)",
        ruleId: "present-tense-r",
        verb: "possessiv",
        tense: "neuter",
      },
      {
        id: "q5",
        sentence: "Han gav ______ en gave til jul.",
        sentenceEn: "He gave her a present for Christmas.",
        answer: "hende",
        blank: "hende",
        hint: "Object pronoun: her = hende",
        ruleId: "present-tense-r",
        verb: "pronomen",
        tense: "object",
      },
      {
        id: "q6",
        sentence: "______ børn går i skole. (vores/deres)",
        sentenceEn: "Our children go to school.",
        answer: "Vores",
        blank: "Vores",
        hint: "Possessive: our = vores",
        ruleId: "present-tense-r",
        verb: "possessiv",
        tense: "plural",
      },
  ...
  },
  {
    ...
    questions: [
      {
        sentence:
          "Selvom det ikke er ret mange penge, er det faktisk nok til at leve ______.",
        answer: "for",
        hint: "Preposition: 'leve for' (to live on).",
        options: ["for", "ikke", "men", "svært"],
      },
      {
        sentence:
          "Kasper synes faktisk ikke, det er så ______ at leve billigt.",
        answer: "svært",
        hint: "Adjective: 'svært' (difficult).",
        options: ["svært", "sjovt", "altid", "heldigvis"],
      },
      {
        sentence:
          "Han bor til leje på et værelse, hvor huslejen ______ ikke er ret høj.",
        answer: "heldigvis",
        hint: "Adverb: 'heldigvis' (fortunately).",
        options: ["heldigvis", "desværre", "altid", "sjældent"],
      },
      {
        sentence: "Og når han skal rundt i Aalborg, cykler han næsten ______.",
        answer: "altid",
        hint: "Adverb: 'altid' (always).",
        options: ["altid", "aldrig", "sjældent", "højest"],
      },
      {
        sentence:
          "Han køber madvarer i det supermarked, hvor prisen er ______.",
        answer: "bedst",
        hint: "Superlative: 'bedst' (best/lowest price).",
        options: ["bedst", "højest", "ikke", "men"],
      },
      {
        sentence:
          "Kasper kan godt lide kød, ______ han synes, det er for dyrt.",
        answer: "men",
        hint: "Conjunction: 'men' (but).",
        options: ["men", "og", "for", "svært"],
      },
      {
        sentence:
          "Han synes faktisk også, det er ret ______ at lave vegetarmad.",
        answer: "sjovt",
        hint: "Adjective: 'sjovt' (fun).",
        options: ["sjovt", "svært", "besøg", "aldrig"],
      },
      {
        sentence: "Derfor inviterer hans mor ham tit på ______.",
        answer: "besøg",
        hint: "Noun: 'besøg' (visit).",
        options: ["besøg", "restaurant", "altid", "for"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      {
        sentence:
          "Denne dag er helt ______, for Allan og Lena har bryllupsdag.",
        answer: "speciel",
        hint: "Adjective: 'speciel' (special).",
        options: ["speciel", "almindelig", "lange", "nemlig"],
      },
      {
        sentence: "Lena er der allerede, for hun har fået ______ fri end ham.",
        answer: "tidligere",
        hint: "Comparative: 'tidligere' (earlier).",
        options: ["tidligere", "senere", "godt", "kun"],
      },
      {
        sentence: "De bliver overraskede, for de har ______ inviteret gæster.",
        answer: "ikke",
        hint: "Negation: 'ikke' (not).",
        options: ["ikke", "altid", "nemlig", "fordi"],
      },
      {
        sentence: "Allan lukker op, ______ han og Lena har lidt travlt.",
        answer: "selvom",
        hint: "Conjunction: 'selvom' (even though).",
        options: ["selvom", "fordi", "men", "nemlig"],
      },
      {
        sentence:
          "Men han fortæller, at de desværre ______ har tid til en hurtig kop kaffe.",
        answer: "kun",
        hint: "Adverb: 'kun' (only).",
        options: ["kun", "ikke", "altid", "senere"],
      },
      {
        sentence: "Allan bliver ______.",
        answer: "irriteret",
        hint: "Adjective: 'irriteret' (annoyed).",
        options: ["irriteret", "glad", "overrasket", "godt"],
      },
      {
        sentence:
          "Hun forstår nemlig ______, at de glæder sig til en aften alene.",
        answer: "godt",
        hint: "Adverb: 'godt' (well/fully).",
        options: ["godt", "ikke", "nemlig", "speciel"],
      },
      {
        sentence:
          "Allan og Lena bliver meget glade, ______ de nu skal til Italien.",
        answer: "fordi",
        hint: "Conjunction: 'fordi' (because).",
        options: ["fordi", "selvom", "men", "nemlig"],
      },
    ],
  },
  {
    ...
    questions: [
      {
        ...
        options: ["mindre", "større", "stille", "for"],
      },
      {
        sentence:
          "For det meste synes Ida, at det er ______ at bo på kollegiet.",
        answer: "hyggeligt",
        hint: "Adjective: 'hyggeligt' (cozy/pleasant).",
        options: ["hyggeligt", "kedeligt", "utilfreds", "altid"],
      },
      {
        sentence: "Det deltager Ida næsten ______ i.",
        answer: "altid",
        hint: "Adverb: 'altid' (always).",
        options: ["altid", "aldrig", "derfor", "for"],
      },
      {
        sentence: "Der er en fyr, der ______ rydder op efter sig.",
        answer: "aldrig",
        hint: "Adverb: 'aldrig' (never).",
        options: ["aldrig", "altid", "stille", "derfor"],
      },
      {
        sentence:
          "Det er Ida ret sur over, ______ det betyder, hun skal gøre rent efter ham.",
        answer: "for",
        hint: "Conjunction: 'for' (because).",
        options: ["for", "selvom", "derfor", "tilfreds"],
      },
      {
        sentence: "Ida er også træt af, at der tit er ______ på kollegiet.",
        answer: "larm",
        hint: "Noun: 'larm' (noise).",
        options: ["larm", "stille", "hyggeligt", "derfor"],
      },
      {
        sentence:
          "Det gør hun hver dag, ______ Ida har bedt hende om at skrue ned.",
        answer: "selvom",
        hint: "Conjunction: 'selvom' (even though).",
        options: ["selvom", "fordi", "derfor", "altid"],
      },
      {
        sentence: "Men alt i alt er Ida ______ med at bo på kollegiet.",
        answer: "tilfreds",
        hint: "Adjective: 'tilfreds' (satisfied).",
        options: ["tilfreds", "utilfreds", "glad", "derfor"],
      },
    ],
  },
];
